...
import {AddNewNewsAction, DeleteNewsAction, EditNewsAction, FetchNewsByTypeAction, SetNewsListAction} from './types/newsActionTypes';
...
export const editNewsAction = (id: string, updateData: Omit<News, '_id'>): EditNewsAction => ({
    type: EDIT_NEWS,
    id,
    updateData,
});
